                                                ...
                                                <div class="card-body p-0">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-md">
                                                            ...
                                                            <?php
                                                            $bookings = "SELECT * from users JOIN orders
                                                            on users.userId = orders.userId
                                                            JOIN showtimes
                                                            on showtimes.showId = orders.showId
                                                            JOIN movies
                                                            on movies.movieId = showtimes.movieId
                                                            JOIN cinemas 
                                                            on cinemas.cinemaId = showtimes.cinemaId
                                                            JOIN seatreserve
                                                            ON users.userId = seatreserve.userId
                                                            order by seats ASC
                                                            ";
                                                            ...
                                                            if (mysqli_num_rows($result) > 0) {
                                                                while ($rows = mysqli_fetch_assoc($result)) { ?>
                                                                    <tr>
                                                                        <td><?php echo $i++; ?></td>
                                                                        <td class="moviename"><?php echo $rows['userName'] ?></td>
                                                                        <td class="movieCat"><?php echo $rows['movieName']; ?></td>
                                                                        <td><?php echo $rows['seats'] ?></td>
                                                                        <td><?php echo $rows['price'] ?></td>
                                                                        <td>
                                                                            <?php echo $rows['cinemaId'] ?>
                                                                        </td>
                                                                        <td>
                                                                            <?php echo $rows['cinemaType'] ?>
                                                                        </td>

                                                                        <td>
                                                                            <?php echo $rows['showDate'] ?>
                                                                        </td>

                                                                        <td>
                                                                            <?php echo $rows['showtimings'] ?>
                                                                        </td>
